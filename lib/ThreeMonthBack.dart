...
class ThreeMonthBack extends StatefulWidget {
  ...
  @override
  _ThreeMonthBackState createState() {
    ...
    return _ThreeMonthBackState(postlist1);
  }
}

class _ThreeMonthBackState extends State<ThreeMonthBack> {
  var key1;
  var data1;
  List<Posts> postlist=[];

  _ThreeMonthBackState(List<Posts> postlist1){
    postlist=postlist1;
  }
  void home(){
    HomePage();
