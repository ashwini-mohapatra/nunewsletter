...
class OneMonthBack extends StatefulWidget {
  ...
  @override
  _OneMonthBackState createState(){
    ...
    return _OneMonthBackState(postlist1);

  }
}

class _OneMonthBackState extends State<OneMonthBack> {

  var key1;
  var data1;
  List<Posts> postlist=[];

  _OneMonthBackState(List<Posts> postlist1){
    postlist=postlist1;
  }
  void home(){
  HomePage();
